...
# ── TRADING CONFIG ────────────────────────────────────────────────────────────
# ── SPOT COINS — Top 30 by market cap, no memecoins ──────────────────────────
SPOT_COINS = [
    "bitcoin","ethereum","ripple","binancecoin","solana",
    "usd-coin","dogecoin","cardano","tron","avalanche-2",
    "the-open-network","chainlink","polkadot","bitcoin-cash","near",
    "matic-network","litecoin","internet-computer","uniswap","stellar",
    "ethereum-classic","okb","cosmos","monero","hedera-hashgraph",
    "filecoin","algorand","vechain","aave","the-graph",
]

# ── FUTURES COINS — memecoins + high volatility altcoins ─────────────────────
FUTURES_COINS = [
    "shiba-inu","pepe","floki","bonk","dogwifhat",
    "sui","aptos","injective-protocol","sei-network","arbitrum",
    "optimism","blur","gmx","jupiter-ag","raydium",
]

# ── ALL COINS — combined for scanning (spot trades SPOT_COINS, futures can trade all)
COINS = SPOT_COINS + FUTURES_COINS

COIN_SYMBOLS = {
    # Spot coins
    "bitcoin":"BTC","ethereum":"ETH","ripple":"XRP","binancecoin":"BNB","solana":"SOL",
    "usd-coin":"USDC","dogecoin":"DOGE","cardano":"ADA","tron":"TRX","avalanche-2":"AVAX",
    "the-open-network":"TON","chainlink":"LINK","polkadot":"DOT","bitcoin-cash":"BCH","near":"NEAR",
    "matic-network":"MATIC","litecoin":"LTC","internet-computer":"ICP","uniswap":"UNI","stellar":"XLM",
    "ethereum-classic":"ETC","okb":"OKB","cosmos":"ATOM","monero":"XMR","hedera-hashgraph":"HBAR",
    "filecoin":"FIL","algorand":"ALGO","vechain":"VET","aave":"AAVE","the-graph":"GRT",
    # Futures-only memecoins & high vol
    "shiba-inu":"SHIB","pepe":"PEPE","floki":"FLOKI","bonk":"BONK","dogwifhat":"WIF",
    "sui":"SUI","aptos":"APT","injective-protocol":"INJ","sei-network":"SEI","arbitrum":"ARB",
    "optimism":"OP","blur":"BLUR","gmx":"GMX","jupiter-ag":"JUP","raydium":"RAY",
}

BINANCE_SYMBOLS = {
    # Spot coins
    "bitcoin":"BTCUSDT","ethereum":"ETHUSDT","ripple":"XRPUSDT","binancecoin":"BNBUSDT","solana":"SOLUSDT",
    "usd-coin":"USDCUSDT","dogecoin":"DOGEUSDT","cardano":"ADAUSDT","tron":"TRXUSDT","avalanche-2":"AVAXUSDT",
    "the-open-network":"TONUSDT","chainlink":"LINKUSDT","polkadot":"DOTUSDT","bitcoin-cash":"BCHUSDT","near":"NEARUSDT",
    "matic-network":"MATICUSDT","litecoin":"LTCUSDT","internet-computer":"ICPUSDT","uniswap":"UNIUSDT","stellar":"XLMUSDT",
    "ethereum-classic":"ETCUSDT","okb":"OKBUSDT","cosmos":"ATOMUSDT","monero":"XMRUSDT","hedera-hashgraph":"HBARUSDT",
    "filecoin":"FILUSDT","algorand":"ALGOUSDT","vechain":"VETUSDT","aave":"AAVEUSDT","the-graph":"GRTUSDT",
    # Futures-only
    "shiba-inu":"SHIBUSDT","pepe":"PEPEUSDT","floki":"FLOKIUSDT","bonk":"BONKUSDT","dogwifhat":"WIFUSDT",
    "sui":"SUIUSDT","aptos":"APTUSDT","injective-protocol":"INJUSDT","sei-network":"SEIUSDT","arbitrum":"ARBUSDT",
    "optimism":"OPUSDT","blur":"BLURUSDT","gmx":"GMXUSDT","jupiter-ag":"JUPUSDT","raydium":"RAYUSDT",
}

# Spot-only flag — these coins only trade on spot, never open spot positions for futures-only coins
FUTURES_ONLY_COINS = set(FUTURES_COINS)
RISK_PER_TRADE  = 0.10
...
MAX_OPEN_TRADES = 999        # no limit — trade all coins simultaneously
MAX_TRADES_PER_COIN = 3    # up to 3 positions per coin (aggressive re-entry)
...
FUTURES_BALANCE     = 10000.0   # starting paper futures margin balance
FUTURES_MIN_LEV     = 7         # minimum leverage AI can pick
FUTURES_MAX_LEV     = 125       # maximum leverage available
FUTURES_MARGIN_TYPE = "isolated" # isolated = each trade separate
FUTURES_RISK_PCT    = 0.10      # 10% of futures balance per trade margin
# Max leverage by asset class (realistic exchange limits)
FUTURES_LEV_LIMITS  = {
    "crypto":     125,   # BTC/ETH etc — up to 125x on Binance
    "altcoin":     50,   # smaller coins — up to 50x
    "commodity":   20,   # Gold/Oil — up to 20x
    "forex":       50,   # EUR/USD etc — up to 50x
}
ASSET_CLASS = {
    # Top market cap — treated as "crypto" (higher lev limit)
    "bitcoin":"crypto","ethereum":"crypto","ripple":"crypto","binancecoin":"crypto","solana":"crypto",
    # Established altcoins
    "dogecoin":"altcoin","cardano":"altcoin","tron":"altcoin","avalanche-2":"altcoin",
    "the-open-network":"altcoin","chainlink":"altcoin","polkadot":"altcoin","bitcoin-cash":"altcoin",
    "near":"altcoin","matic-network":"altcoin","litecoin":"altcoin","internet-computer":"altcoin",
    "uniswap":"altcoin","stellar":"altcoin","ethereum-classic":"altcoin","okb":"altcoin",
    "cosmos":"altcoin","monero":"altcoin","hedera-hashgraph":"altcoin","filecoin":"altcoin",
    "algorand":"altcoin","vechain":"altcoin","aave":"altcoin","the-graph":"altcoin","usd-coin":"altcoin",
    # Futures-only memecoins & high vol (use altcoin lev limit of 50x)
    "shiba-inu":"altcoin","pepe":"altcoin","floki":"altcoin","bonk":"altcoin","dogwifhat":"altcoin",
    "sui":"altcoin","aptos":"altcoin","injective-protocol":"altcoin","sei-network":"altcoin",
    "arbitrum":"altcoin","optimism":"altcoin","blur":"altcoin","gmx":"altcoin",
    "jupiter-ag":"altcoin","raydium":"altcoin",
    # Commodities & Forex
    "gold":"commodity","silver":"commodity","oil-wti":"commodity",
    "natural-gas":"commodity","copper":"commodity",
    "eur-usd":"forex","gbp-usd":"forex","usd-jpy":"forex","aud-usd":"forex","usd-chf":"forex",
}

# ── PRICE CACHE ───────────────────────────────────────────────────────────────
_price_cache      = {}
_price_cache_time = 0
PRICE_CACHE_TTL   = 1800  # 30 min cache — CoinGecko hit limits, longer cache, Binance handles live prices

# ── BINANCE TICK CACHE (real-time prices for scalping) ─────────────────────────
_binance_cache      = {}
_binance_cache_time = 0
BINANCE_CACHE_TTL   = 15  # refresh every 15 seconds — matches scan interval
...
state = {
    ...
    "groq_pause_until": 0,
    # Futures state
    "futures_balance":      FUTURES_BALANCE,   # $10,000 starting — DO NOT cross-contaminate with spot
    "futures_positions":    {},   # open futures positions
    "futures_history":      [],   # closed futures trades
    "futures_total_pnl":    0.0,
    "futures_daily_pnl":    0.0,
    "futures_wins":         0,
    "futures_losses":       0,
    "futures_liquidations": 0,
}
...
def get_binance_prices() -> dict:
    ...
    try:
        ...
        logger.warning(f"Binance batch error: {e} — trying individual calls")
        try:
            result = {}
            for coin_id in list(BINANCE_SYMBOLS.keys()):
                sym = BINANCE_SYMBOLS[coin_id]
                try:
                    r2 = requests.get(
                    ...
                    continue
                t = r2.json()
                if not isinstance(t, dict) or "lastPrice" not in t:
                    continue
                price      = float(t["lastPrice"])
                prev_close = float(t.get("prevClosePrice", price))
                change_24h = ((price - prev_close) / prev_close * 100) if prev_close else 0
                bid        = float(t.get("bidPrice", price))
                ask        = float(t.get("askPrice", price))
                spread_pct = ((ask - bid) / bid * 100) if bid else 0
                wap        = float(t.get("weightedAvgPrice", price))
                micro_mom  = ((price - wap) / wap * 100) if wap else 0
                result[coin_id] = {
                    "price": price, "change_24h": round(change_24h,3),
                    "high_24h": float(t.get("highPrice",price)),
                    "low_24h":  float(t.get("lowPrice",price)),
                    "volume_24h": float(t.get("quoteVolume",0)),
                    "micro_mom": round(micro_mom,4),
                    "bid": bid, "ask": ask,
                    "spread_pct": round(spread_pct,4),
                    "trades_count": int(t.get("count",0)),
                    "price_change_pct": round(float(t.get("priceChangePercent",0)),3),
                }
            if result:
                _binance_cache      = result
                _binance_cache_time = _t.time()
                logger.info(f"Binance individual calls OK — {len(result)} coins")
            return result
        except Exception as e2:
            logger.warning(f"Binance individual calls also failed: {e2}")
            return _binance_cache
...
def get_prices() -> dict:
    ...
    ids = ",".join(SPOT_COINS)  # only fetch spot coins — saves CoinGecko API calls
    try:
        r = requests.get(
...
Respond ONLY with valid JSON, no markdown, no fences:
{
  ...
  "confidence_threshold": <integer 0-100, YOUR required minimum>,
  "strategy": "scalp" | "momentum" | "news" | "reversal",
  "stop_loss_pct": <float, e.g. 0.008>,
  "take_profit_pct": <float, e.g. 0.015>,
  "leverage": <integer, 7-125 based on asset and setup strength>,
  "reasoning": "<2 sentences — exact trade thesis>",
  "sentiment": "bullish" | "bearish" | "neutral",
  "key_news": "<most impactful headline or 'No major news'>",
  "risk_level": "low" | "medium" | "high",
  "suggested_hold_duration": "<e.g. 5-15 mins, 1-2 hours>",
  "price_target": <float>,
  "stop_price": <float>,
  "market_summary": "<1 sentence>",
  "trade_urgency": "immediate" | "normal" | "patient",
  "entry_reason": "<specific trigger>"
}
...
- Be VERY aggressive — trade frequently, re-enter fast after exits
- On re-entry after a loss: analyse if conditions changed, re-enter immediately if still valid
- Compound sizing: as portfolio grows, stake sizes grow automatically
- Never let cash sit idle — if there's a setup, take it
- DIRECTION: set "long" when bullish, "short" when bearish — trade BOTH sides
- LEVERAGE rules:
  * Scalp with clear momentum: 25-75x
  * Strong news catalyst: 50-125x (crypto only)
  * Reversal/counter-trend: 7-20x (risky, use lower lev)
  * Forex/commodities: max 20-50x
  * When uncertain: 7-15x minimum
- Keep reasoning under 40 words to save tokens"""
...
Spread:{b.get('spread_pct',0):.3f}% MicroMom:{b.get('micro_mom',0):+.3f}% Scalp:{'READY-'+scalp_signal.get('direction','').upper() if scalp_signal.get('scalp_ready') else 'NO'}
RSI:{technicals['rsi']} MACD:{technicals['macd_trend']} BB:{technicals['bb_position']} TA:{technicals['signal'].upper()}
Mom:{momentum.get('trend','?')}({momentum.get('momentum_pct',0):+.2f}%) Pos:{open_trade_context} Cash:${state['cash_balance']:,.0f}
News:{news_short}
JSON:"""
...
def paper_short_open(coin_id: str, price: float, decision: dict = None) -> dict:
    """Open a paper spot short position (borrow and sell)."""
    prices_data   = get_prices()
    portfolio_val = get_portfolio_value(prices_data)
    usdt_amount   = portfolio_val * state["risk_per_trade"]
    usdt_amount   = min(usdt_amount, state["cash_balance"] * 0.95)
    if usdt_amount < 0.01:
        return {}

    sl_pct = decision.get("stop_loss_pct") or STOP_LOSS_PCT if decision else STOP_LOSS_PCT
    tp_pct = decision.get("take_profit_pct") or TAKE_PROFIT_PCT if decision else TAKE_PROFIT_PCT
    sl_pct = max(0.002, min(sl_pct, 0.15))
    tp_pct = max(0.005, min(tp_pct, 0.50))

    qty          = usdt_amount / price
    # Short: profit when price falls
    sl_price     = round(price * (1 + sl_pct), 8)   # SL above entry
    tp_price     = round(price * (1 - tp_pct), 8)   # TP below entry

    state["cash_balance"] -= usdt_amount  # lock margin
    ...
    logger.info(f"PAPER SHORT {coin_id}: qty={qty:.6f} @ ${price} | SL=${sl_price} TP=${tp_price}")
    save_state()
    return trade


def paper_buy(coin_id: str, price: float, decision: dict = None) -> dict:
    """Execute paper buy. Compounds gains — risk is % of current total portfolio."""
    # COMPOUND: base risk on full portfolio value, not just cash
    prices_data   = get_prices()
    portfolio_val = get_portfolio_value(prices_data)
    usdt_amount   = portfolio_val * state["risk_per_trade"]
...
def paper_short_close(coin_id: str, price: float) -> float:
    """Close a paper short position. Profit when price fell."""
    trade = state["open_trades"].pop(coin_id, None)
    if not trade:
        return 0.0
    entry    = trade["entry_price"]
    qty      = trade["qty"]
    margin   = trade["usdt_spent"]
    pnl      = (entry - price) * qty   # profit when price drops
    returned = margin + pnl
    state["cash_balance"] += max(0, returned)
    symbol   = COIN_SYMBOLS.get(coin_id, coin_id.upper())
    ...
    save_state()
    logger.info(f"PAPER SHORT CLOSE {coin_id}: pnl={pnl:.4f} ({pnl_pct:+.2f}%)")
    return pnl
...
# Re-entry watchlist: {coin_id: {"hit_at": timestamp, "type": "sl/tp"}}
_reentry_watchlist: dict = {}


def get_max_leverage(coin_id: str) -> int:
    """Get max leverage for this asset class."""
    asset_class = ASSET_CLASS.get(coin_id, "altcoin")
    return FUTURES_LEV_LIMITS.get(asset_class, 50)


def futures_open(coin_id: str, price: float, direction: str, decision: dict) -> dict | None:
    """
    Open a paper futures position.
    direction: 'long' or 'short'
    Returns the position dict or None if insufficient balance.
    """
    if not FUTURES_ENABLED:
        return None

    # Sanity check — futures balance should never exceed $5M (catch corruption)
    if state["futures_balance"] > 5_000_000:
        logger.error(f"Futures balance corruption detected: ${state['futures_balance']:,.2f} — resetting to $10,000")
        state["futures_balance"] = FUTURES_BALANCE
        return None

    # AI-decided leverage — clamped between min and asset max
    max_lev  = get_max_leverage(coin_id)
    ai_lev   = decision.get("leverage", FUTURES_MIN_LEV)
    leverage = max(FUTURES_MIN_LEV, min(int(ai_lev), max_lev))

    # Margin = % of futures balance — hard capped to prevent runaway sizing
    raw_margin = state["futures_balance"] * FUTURES_RISK_PCT
    # Hard caps: min $1, max 20% of current balance, absolute max $5000 per trade
    margin = max(1.0, min(raw_margin, state["futures_balance"] * 0.20, 5000.0))

    if margin > state["futures_balance"]:
        logger.warning(f"Insufficient futures balance for {coin_id}: need ${margin:.2f}, have ${state['futures_balance']:.2f}")
        return None

    logger.info(f"Futures margin calc: balance=${state['futures_balance']:.2f} x {FUTURES_RISK_PCT*100:.0f}% = ${raw_margin:.2f} → capped to ${margin:.2f}")

    notional     = margin * leverage          # total position size in USDT
    qty          = notional / price           # units of asset
    sl_pct       = decision.get("stop_loss_pct") or (1 / leverage)   # default: 1 leverage unit
    tp_pct       = decision.get("take_profit_pct") or (sl_pct * 2)   # default: 2:1 R/R
    sl_pct       = max(0.001, min(sl_pct, 0.50))
    tp_pct       = max(0.002, min(tp_pct, 2.00))

    # SL/TP price based on direction
    if direction == "long":
        sl_price = round(price * (1 - sl_pct), 8)
        tp_price = round(price * (1 + tp_pct), 8)
        liq_price = round(price * (1 - 1/leverage * 0.95), 8)  # 95% of margin
    else:  # short
        sl_price = round(price * (1 + sl_pct), 8)
        tp_price = round(price * (1 - tp_pct), 8)
        liq_price = round(price * (1 + 1/leverage * 0.95), 8)

    # Deduct margin from balance (isolated)
    state["futures_balance"] -= margin
    ...
    key = f"fut_{coin_id}_{direction}_{int(datetime.utcnow().timestamp())}"
    state["futures_positions"][key] = position
    logger.info(f"FUTURES {direction.upper()} {symbol} x{leverage} @ ${price} | "
                f"Margin: ${margin:.2f} | Notional: ${notional:.2f} | "
                f"SL: ${sl_price} TP: ${tp_price} LIQ: ${liq_price}")
    save_state()
    return position


def futures_close(key: str, price: float, reason: str = "signal") -> float:
    """Close a futures position. Returns realised PnL."""
    pos = state["futures_positions"].pop(key, None)
    if not pos:
        return 0.0
    ...
    returned = margin + pnl
    state["futures_balance"] += max(0, returned)  # 0 if liquidated

    state["futures_total_pnl"] += pnl
    state["futures_daily_pnl"] += pnl
    roi_pct = (pnl / margin * 100) if margin > 0 else 0

    if reason == "liquidation":
        state["futures_liquidations"] += 1
        state["futures_losses"]       += 1
    elif pnl >= 0:
        state["futures_wins"]   += 1
    else:
        state["futures_losses"] += 1
    ...
    state["futures_history"].insert(0, record)
    state["futures_history"] = state["futures_history"][:200]
    save_state()
    logger.info(f"FUTURES CLOSE {pos['symbol']} {pos['direction'].upper()} | "
                f"PnL: {pnl:+.4f} ({roi_pct:+.1f}%) | Reason: {reason}")
    return pnl


async def check_futures_sl_tp_liq(prices_data: dict):
    """Check all open futures positions for SL/TP/liquidation."""
    for key in list(state["futures_positions"].keys()):
        pos = state["futures_positions"].get(key)
        if not pos:
            continue

        base_coin = pos["coin_id"].split("_")[0]
        price     = prices_data.get(base_coin, prices_data.get(pos["coin_id"], {})).get("price", 0)
        if not price:
            continue
        ...
        if direction == "long":
            unr_pnl = (price - pos["entry_price"]) * pos["qty"]
        else:
            unr_pnl = (pos["entry_price"] - price) * pos["qty"]
        state["futures_positions"][key]["unrealised_pnl"] = round(unr_pnl, 4)

        # Check liquidation first
        liq = pos["liq_price"]
        hit_liq = (direction == "long" and price <= liq) or                   (direction == "short" and price >= liq)

        # Check SL
        hit_sl = (direction == "long" and price <= pos["sl_price"]) or                  (direction == "short" and price >= pos["sl_price"])

        # Check TP
        hit_tp = (direction == "long" and price >= pos["tp_price"]) or                  (direction == "short" and price <= pos["tp_price"])

        if hit_liq:
            pnl    = futures_close(key, liq, "liquidation")
            dir_emoji = "📈" if direction == "long" else "📉"
            await notify(
                f"💥 <b>LIQUIDATION</b> {dir_emoji} {symbol} x{lev}\n"
                f"━━━━━━━━━━━━━━━━━━━━\n"
                f"Entry: ${pos['entry_price']:,.4f} → Liq: ${liq:,.4f}\n"
                f"❌ Margin lost: ${pos['margin']:,.2f}\n"
                f"💵 Futures balance: ${state['futures_balance']:,.2f}"
            )
            add_to_reentry(base_coin, "liquidation")

        elif hit_sl:
            pnl    = futures_close(key, pos["sl_price"], "stop_loss")
            roi    = (pnl / pos["margin"] * 100)
            dir_emoji = "📈" if direction == "long" else "📉"
            await notify(
                f"🛑 <b>FUTURES SL</b> {dir_emoji} {symbol} x{lev}\n"
                f"Entry: ${pos['entry_price']:,.4f} → SL: ${pos['sl_price']:,.4f}\n"
                f"❌ PnL: {pnl:+.4f} USDT ({roi:+.1f}% on margin)\n"
                f"💵 Futures balance: ${state['futures_balance']:,.2f}"
            )
            add_to_reentry(base_coin, "sl")

        elif hit_tp:
            pnl    = futures_close(key, pos["tp_price"], "take_profit")
            roi    = (pnl / pos["margin"] * 100)
            dir_emoji = "📈" if direction == "long" else "📉"
            await notify(
                f"🎯 <b>FUTURES TP</b> {dir_emoji} {symbol} x{lev}\n"
                f"Entry: ${pos['entry_price']:,.4f} → TP: ${pos['tp_price']:,.4f}\n"
                f"✅ PnL: +{pnl:.4f} USDT (+{roi:.1f}% on margin)\n"
                f"💵 Futures balance: ${state['futures_balance']:,.2f}"
            )
            add_to_reentry(base_coin, "tp")

def add_to_reentry(coin_id: str, hit_type: str):
    """Add coin to re-entry watchlist after SL/TP hit."""
    _reentry_watchlist[coin_id] = {
        "hit_at":  datetime.utcnow().isoformat(),
        "type":    hit_type,
        "count":   _reentry_watchlist.get(coin_id, {}).get("count", 0) + 1,
    }
    logger.info(f"Re-entry watchlist: {coin_id} added after {hit_type}")
...
async def check_stop_loss_take_profit(prices_data: dict):
    ...
    for coin_id in list(state["open_trades"].keys()):
        ...
        if not trade:
            continue
        # Resolve base coin from keyed variants (coin_id_2, coin_id_double_xxx etc)
        base_coin = coin_id.split("_")[0] if "_" in coin_id else coin_id
        price = prices_data.get(base_coin, prices_data.get(coin_id, {})).get("price", 0)
        if not price:
            continue

        direction_t = trade.get("direction", "long")
        if direction_t == "short":
            hit_sl = price >= trade.get("stop_loss", float("inf"))   # SL above entry for shorts
            hit_tp = price <= trade.get("take_profit", 0)             # TP below entry for shorts
        else:
        ...
        if hit_sl or hit_tp:
            ...
            if direction_t == "short":
                pnl = paper_short_close(coin_id, price)
            else:
            ...
            if pnl >= 0:
                ...
                add_to_reentry(base_coin, "sl")
            symbol = COIN_SYMBOLS.get(base_coin, base_coin.upper())
...
async def scan_and_trade():
    ...
    # Get Binance prices first — retry up to 3 times on failure
    binance_live = {}
    for attempt in range(3):
        binance_live = get_binance_prices()
        if binance_live:
            break
        logger.warning(f"Binance fetch attempt {attempt+1}/3 failed, retrying in 3s...")
        await asyncio.sleep(3)

    # CoinGecko for context (cached 15 mins)
    prices_data   = get_prices()

    # Merge ALL Binance live prices into prices_data (including futures-only coins)
    for cid, b in binance_live.items():
        if not b.get("price", 0):
            continue
        if cid in prices_data:
            ...
            prices_data[cid]["change_24h"] = b.get("price_change_pct", prices_data[cid].get("change_24h",0))
        else:
            prices_data[cid] = {
                "price": b["price"], "symbol": COIN_SYMBOLS.get(cid, cid.upper()),
                "name": COIN_SYMBOLS.get(cid, cid.upper()),
                "change_24h": b.get("price_change_pct", 0),
                "volume_24h": b.get("volume_24h", 0),
                "high_24h": b.get("high_24h", 0), "low_24h": b.get("low_24h", 0),
                **b
            }
    ...
    await check_futures_sl_tp_liq(prices_data)
    ...
    for coin_id in COINS:
        try:
            # Stagger AI calls every 5 coins to avoid Groq 429
            ...
            # Flag if this coin is on re-entry watchlist
            reentry_info = _reentry_watchlist.get(coin_id)
            if reentry_info:
                logger.info(f"Re-entry candidate: {coin_id} (prev {reentry_info['type']} hit #{reentry_info['count']})")
            ...
            # AI sets its own confidence threshold — no floor
            ai_threshold = decision.get("confidence_threshold", 0)
            # Count open trades for this coin
            coin_trades = sum(1 for k in state["open_trades"] if k.startswith(coin_id))
            # Spot trading blocked for futures-only coins (memecoins etc)
            spot_allowed = coin_id not in FUTURES_ONLY_COINS
            can_buy = (
                action == "BUY" and
                confidence >= ai_threshold and
                coin_trades < MAX_TRADES_PER_COIN and
                len(state["open_trades"]) < MAX_OPEN_TRADES and
                state["cash_balance"] >= price * 0.001 and
                spot_allowed   # no spot trades on memecoins
            )
            # For futures-only coins: open futures even if spot is blocked
            if not spot_allowed and action == "BUY" and confidence >= ai_threshold and                FUTURES_ENABLED and state["futures_balance"] > 10 and                not any(p.get("coin_id") == coin_id for p in state["futures_positions"].values()):
                direction = decision.get("direction", "long")
                fut_pos   = futures_open(coin_id, price, direction, decision)
                if fut_pos:
                    lev   = fut_pos["leverage"]
                    sym   = fut_pos["symbol"]
                    dir_e = "📈" if direction == "long" else "📉"
                    await notify(
                        f"⚡ <b>FUTURES ONLY</b> {dir_e} {sym} x{lev} (memecoin — no spot)\n"
                        f"Margin: ${fut_pos['margin']:,.2f} | Notional: ${fut_pos['notional']:,.2f}\n"
                        f"TP: ${fut_pos['tp_price']:,.4f} | SL: ${fut_pos['sl_price']:,.4f}\n"
                        f"💥 Liq: ${fut_pos['liq_price']:,.4f}"
                    )

            if can_buy:
                # Use unique key for multi-position: coin_id, coin_id_2, coin_id_3
                trade_key = coin_id if coin_id not in state["open_trades"] else                             f"{coin_id}_2" if f"{coin_id}_2" not in state["open_trades"] else                             f"{coin_id}_3"
                trade = paper_buy(coin_id, price, decision)
                # Re-key if duplicate
                if trade_key != coin_id and coin_id in state["open_trades"]:
                    state["open_trades"][trade_key] = state["open_trades"].pop(coin_id)
                    trade["trade_key"] = trade_key
                state["open_trades"].get(trade_key, trade)["strategy"] = decision.get("strategy", "")
                state["trades_today"] += 1
                await notify(format_trade_alert(coin_id, "BUY", decision, price_data, trade))

                # ── PAPER FUTURES POSITION (runs alongside spot) ───────────
                # Futures trade ALL coins including memecoins
                if FUTURES_ENABLED and state["futures_balance"] > 10:
                    direction = decision.get("direction", "long")
                    fut_pos   = futures_open(coin_id, price, direction, decision)
                    if fut_pos:
                        lev   = fut_pos["leverage"]
                        ...
                        dir_e = "📈" if direction == "long" else "📉"
                        await notify(
                            f"⚡ <b>FUTURES {direction.upper()}</b> {dir_e} {sym} x{lev}\n"
                            f"━━━━━━━━━━━━━━━━━━━━\n"
                            f"💰 Margin: ${fut_pos['margin']:,.2f} → Notional: ${fut_pos['notional']:,.2f}\n"
                            f"📊 Entry: ${price:,.4f}\n"
                            f"🎯 TP: ${fut_pos['tp_price']:,.4f} (+{fut_pos['tp_pct']:.2f}%) | "
                            f"🛑 SL: ${fut_pos['sl_price']:,.4f} (-{fut_pos['sl_pct']:.2f}%)\n"
                            f"💥 Liq: ${fut_pos['liq_price']:,.4f}\n"
                            f"💵 Futures bal: ${state['futures_balance']:,.2f}"
                        )

            # MOMENTUM DOUBLING: add to position if up >0.5% and AI still bullish
            if open_trade and action == "BUY" and confidence >= ai_threshold:
                current_price = price_data.get("price", 0)
                entry_price   = open_trade.get("entry_price", current_price)
                unrealised_pct = ((current_price - entry_price) / entry_price * 100) if entry_price else 0
                if unrealised_pct >= 0.5 and state["cash_balance"] > current_price * 0.001:
                    # Double down — add same size position
                    extra_trade = paper_buy(coin_id, current_price, decision)
                    double_key  = f"{coin_id}_double_{int(datetime.utcnow().timestamp())}"
                    state["open_trades"][double_key] = extra_trade
                    state["trades_today"] += 1
                    await notify(
                        f"🚀 <b>MOMENTUM DOUBLE</b> — {COIN_SYMBOLS.get(coin_id,'?')}\n"
                        f"Trade up {unrealised_pct:+.2f}% — adding to position\n"
                        f"Entry: ${current_price:,.4f} | Conf: {confidence}%"
                    )
                    logger.info(f"Momentum double on {coin_id}: +{unrealised_pct:.2f}%")

            # ── SPOT SHORT: open if AI bearish and no position ────────────
            direction = decision.get("direction", "long")
            if direction == "short" and action in ("BUY","SELL") and not open_trade:
                ai_threshold2 = decision.get("confidence_threshold", 0)
                if confidence >= ai_threshold2 and state["cash_balance"] > price * 0.001:
                    short_trade = paper_short_open(coin_id, price, decision)
                    if short_trade:
                        symbol = COIN_SYMBOLS.get(coin_id, coin_id.upper())
                        state["trades_today"] += 1
                        await notify(
                            f"📉 <b>PAPER SHORT</b> {symbol}\n"
                            f"Entry: ${price:,.4f} | Qty: {short_trade['qty']:.6f}\n"
                            f"🎯 TP: ${short_trade['take_profit']:,.4f} | "
                            f"🛑 SL: ${short_trade['stop_loss']:,.4f}\n"
                            f"🤖 Conf: {confidence}% | {decision.get('strategy','')}"
                        )

            # ── SPOT SHORT CLOSE: if short open and AI turns bullish ───────
            if open_trade and open_trade.get("direction") == "short" and direction == "long":
                ai_threshold3 = decision.get("confidence_threshold", 0)
                if confidence >= ai_threshold3:
                    pnl = paper_short_close(coin_id, price)
                    state["total_pnl"]  += pnl
                    state["daily_pnl"]  += pnl
                    ...
                    symbol = COIN_SYMBOLS.get(coin_id, coin_id.upper())
                    await notify(
                        f"🔒 <b>SHORT CLOSED</b> {symbol}\n"
                        f"{'✅' if pnl>=0 else '❌'} PnL: {pnl:+.4f} USDT\n"
                        f"Entry: ${open_trade['entry_price']:,.4f} → Exit: ${price:,.4f}"
                    )

            # ── FUTURES SIGNAL-BASED CLOSE ────────────────────────────────
            if FUTURES_ENABLED:
                # Close any futures positions for this coin if AI says opposite
                for fut_key in list(state["futures_positions"].keys()):
                    fut_pos = state["futures_positions"].get(fut_key, {})
                    if fut_pos.get("coin_id") != coin_id:
                        continue
                    should_close = (
                        (fut_pos["direction"] == "long"  and action == "SELL" and confidence >= decision.get("confidence_threshold",0)) or
                        (fut_pos["direction"] == "short" and action == "BUY"  and confidence >= decision.get("confidence_threshold",0))
                    )
                    if should_close:
                        pnl = futures_close(fut_key, price, "signal")
                        roi = (pnl / fut_pos["margin"] * 100) if fut_pos["margin"] else 0
                        await notify(
                            f"🔒 <b>FUTURES CLOSE</b> {fut_pos['symbol']} x{fut_pos['leverage']}\n"
                            f"{'✅' if pnl>=0 else '❌'} PnL: {pnl:+.4f} USDT ({roi:+.1f}%)\n"
                            f"💵 Futures bal: ${state['futures_balance']:,.2f}"
                        )

            elif action == "SELL" and confidence >= decision.get("confidence_threshold", 0) and open_trade:
                pnl = paper_sell(coin_id, price)
                state["daily_pnl"]  += pnl
                state["total_pnl"]  += pnl
                state["wins" if pnl >= 0 else "losses"] += 1
...
async def cmd_topup(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    """Add funds. Usage: /topup 10000 or /topup 10000 futures"""
    try:
        amount = float(ctx.args[0]) if ctx.args else 10000
        target = ctx.args[1].lower() if len(ctx.args) > 1 else "spot"
        amount = max(1, min(amount, 5_000_000))

        if target == "futures":
            state["futures_balance"] += amount
            save_state()
            await update.message.reply_text(
                f"⚡ <b>FUTURES TOPPED UP ${amount:,.2f}</b>\n"
                f"━━━━━━━━━━━━━━━━━━━━\n"
                f"⚡ Futures balance: ${state['futures_balance']:,.2f}\n\n"
                f"Usage: /topup <amount> futures\n"
                f"/topup 50000 futures — add $50K to futures",
                parse_mode=ParseMode.HTML,
            )
        else:
            ...
            portfolio_val = get_portfolio_value(prices_data)
            await update.message.reply_text(
                f"💰 <b>SPOT TOPPED UP ${amount:,.2f}</b>\n"
                f"━━━━━━━━━━━━━━━━━━━━\n"
                f"💵 Cash balance: ${state['cash_balance']:,.2f}\n"
                f"📊 Portfolio value: ${portfolio_val:,.2f}\n"
                f"⚡ Futures balance: ${state['futures_balance']:,.2f}\n\n"
                f"💡 For futures: /topup 10000 futures\n"
                f"Quick: /topup 10000 | /topup 100000 | /topup 1000000 | /topup 5000000",
                parse_mode=ParseMode.HTML,
            )
    except (ValueError, IndexError):
        await update.message.reply_text(
            f"Usage: /topup <amount> [spot|futures]\n\n"
            f"Spot examples:\n"
            f"/topup 10000\n"
            f"/topup 1000000\n\n"
            f"Futures examples:\n"
            f"/topup 10000 futures\n"
            f"/topup 500000 futures\n\n"
            f"💵 Spot cash: ${state['cash_balance']:,.2f}\n"
            f"⚡ Futures: ${state['futures_balance']:,.2f}"
        )
...
async def scheduler(app_tg: Application):
    ...
    await notify(
        ...
        f"⚡ Scans: Every 60s | 30 spot coins + 15 futures-only memecoins\n"
        f"💰 Spot: top30 no memes | Futures: all coins incl memecoins\n"
...
def run_telegram_bot():
    ...
    Uses polling with a startup delay to avoid 409 conflicts on Railway redeploys.
    """
    import asyncio
    import time as _time
    ...
    async def run():
        ...
        # ── Step 1: Delete any existing webhook first ──────────────────────────
        # This forcefully clears the previous instance's connection
        try:
            import httpx
            async with httpx.AsyncClient() as client:
                ...
                logger.info(f"Pre-start webhook delete: {r.json().get('result')}")
        except Exception as e:
            logger.warning(f"Pre-start webhook delete failed: {e}")

        # ── Step 2: Wait for old instance to fully die ─────────────────────────
        # Railway keeps old container alive for ~5s during rolling deploy
        logger.info("Waiting 8s for previous instance to terminate...")
        ...
        app_tg.add_handler(CommandHandler("topup",     cmd_topup))
        app_tg.add_handler(CallbackQueryHandler(handle_approval_callback))

        # ── Step 4: Initialize with retries ───────────────────────────────────
        for attempt in range(1, 6):
            ...
            logger.error("Telegram failed after 5 attempts — running without Telegram commands.")
        ...
        logger.info("Telegram bot polling started ✅ (409-safe)")

        # ── Step 5: Run trading scheduler forever ─────────────────────────────
        await scheduler(app_tg)
...
<div class="nav">
  ...
  <div class="nav-tab" onclick="switchTab('futures',this)" style="color:var(--yellow)">⚡ Futures</div>
</div>
...
<div id="page-futures" class="page">
  <div class="grid grid-4" style="margin-bottom:16px">
    <div class="card">
      <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>Futures Balance</div>
      <div class="kpi-value" id="futBalance" style="color:var(--yellow)">$--</div>
      <div class="kpi-change" id="futPnl">--</div>
      <div class="kpi-sub">Started at $10,000.00</div>
    </div>
    <div class="card">
      <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>Open Positions</div>
      <div class="kpi-value" id="futOpenCount" style="color:var(--yellow)">--</div>
      <div class="kpi-change" id="futUnrealised">Unrealised: $--</div>
      <div class="kpi-sub">Long + Short combined</div>
    </div>
    <div class="card">
      <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>Win Rate</div>
      <div class="kpi-value" id="futWinRate">--%</div>
      <div class="kpi-change" id="futWinsLosses">-- W / -- L</div>
      <div class="kpi-sub">Liquidations: <span id="futLiqs" class="down">0</span></div>
    </div>
    <div class="card">
      <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>Total Futures PnL</div>
      <div class="kpi-value" id="futTotalPnl">$--</div>
      <div class="kpi-change" id="futDailyPnl">Today: $--</div>
      <div class="kpi-sub">Paper leveraged trading</div>
    </div>
  </div>
  <div class="card" style="margin-bottom:16px">
    <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>⚡ Open Futures Positions
      <span style="margin-left:auto;font-size:0.65rem;color:var(--text-dim)">Long 📈 | Short 📉</span>
    </div>
    <div class="scroll-panel">
      <table class="data-table">
        <thead><tr><th>Symbol</th><th>Dir</th><th>Lev</th><th>Entry</th><th>Current</th><th>Margin</th><th>Notional</th><th>Unrealised</th><th>TP</th><th>SL</th><th>Liq</th></tr></thead>
        <tbody id="futPositionsTbody"><tr><td colspan="11" class="empty">No open futures positions</td></tr></tbody>
      </table>
    </div>
  </div>
  <div class="card">
    <div class="card-title"><span class="dot" style="background:var(--yellow)"></span>Futures History</div>
    <div class="scroll-panel" style="max-height:400px">
      <table class="data-table">
        <thead><tr><th>Symbol</th><th>Dir</th><th>Lev</th><th>Entry</th><th>Exit</th><th>Margin</th><th>PnL</th><th>ROI%</th><th>Reason</th><th>Time</th></tr></thead>
        <tbody id="futHistoryTbody"><tr><td colspan="10" class="empty">No closed futures trades</td></tr></tbody>
      </table>
    </div>
  </div>
</div>
...
<div id="page-settings" class="page">
  <div class="grid grid-2">
    ...
    <div class="card">
      <div class="card-title"><span class="dot"></span>Top Up Balance</div>
      <div style="font-family:var(--mono);font-size:0.8rem;color:var(--text-dim);margin-bottom:10px">
        Add funds to your paper trading balance
      </div>
      <div style="font-family:var(--mono);font-size:0.72rem;color:var(--text-dim);margin-bottom:6px">💵 SPOT BALANCE</div>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
        <button class="btn success" onclick="topup(10000,'spot')">+$10K</button>
        <button class="btn success" onclick="topup(100000,'spot')">+$100K</button>
        <button class="btn success" onclick="topup(500000,'spot')">+$500K</button>
        <button class="btn success" onclick="topup(1000000,'spot')">+$1M</button>
        <button class="btn success" onclick="topup(5000000,'spot')">+$5M</button>
        <button class="btn success" onclick="topup(parseFloat(document.getElementById('customTopupSpot').value)||0,'spot')">Custom</button>
      </div>
      <input type="number" id="customTopupSpot" placeholder="Spot custom amount"
        style="background:var(--bg0);border:1px solid var(--border);color:var(--text);
        font-family:var(--mono);font-size:0.78rem;padding:6px 10px;border-radius:3px;width:100%;margin-bottom:12px"/>

      <div style="font-family:var(--mono);font-size:0.72rem;color:var(--yellow);margin-bottom:6px">⚡ FUTURES BALANCE</div>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
        <button class="btn warn" onclick="topup(10000,'futures')">+$10K</button>
        <button class="btn warn" onclick="topup(100000,'futures')">+$100K</button>
        <button class="btn warn" onclick="topup(500000,'futures')">+$500K</button>
        <button class="btn warn" onclick="topup(1000000,'futures')">+$1M</button>
        <button class="btn warn" onclick="topup(5000000,'futures')">+$5M</button>
        <button class="btn warn" onclick="topup(parseFloat(document.getElementById('customTopupFut').value)||0,'futures')">Custom</button>
      </div>
      <input type="number" id="customTopupFut" placeholder="Futures custom amount"
        style="background:var(--bg0);border:1px solid var(--border);color:var(--text);
        font-family:var(--mono);font-size:0.78rem;padding:6px 10px;border-radius:3px;width:100%"/>
    </div>
    <div class="card">
...
function renderAll(d){
  ...
  fns.forEach(fn=>{try{fn()}catch(e){console.warn('Render error:',e.message)}});
  try{document.getElementById('statusDot').className='status-dot'+(d.paused?' paused':'');}catch(e){}
}
...
function renderPortfolioChart(d){
  ...
  if(h.length === 0) h = [{time:'Start', value: 10000}];
...
function renderOpenTrades(d){
  ...
  }).join(''):'<tr><td colspan="7" class="empty">No open trades — bot is scanning...</td></tr>'  ;
}
...
function renderActivityLog(d){
  ...
  }).join('')||'<div style="color:var(--text-dim);padding:20px;text-align:center;font-size:0.8rem">⏳ Waiting for first scan (60s)...</div>'  ;
}
...
function renderFutures(d){
  const fb=d.futures_balance||0, fpnl=d.futures_total_pnl||0;
  const fdpnl=d.futures_daily_pnl||0;
  const fw=d.futures_wins||0, fl=d.futures_losses||0, fliq=d.futures_liquidations||0;
  const fwr=fw+fl>0?(fw/(fw+fl)*100):0;
  document.getElementById('futBalance').textContent='$'+fmt(fb);
  const fpEl=document.getElementById('futPnl');
  fpEl.textContent=(fpnl>=0?'+$':'-$')+fmt(Math.abs(fpnl))+' Total PnL';
  fpEl.className='kpi-change '+(fpnl>=0?'up':'down');
  const positions=d.futures_positions||{};
  const posArr=Object.values(positions);
  document.getElementById('futOpenCount').textContent=posArr.length;
  const totalUnr=posArr.reduce((s,p)=>s+(p.unrealised_pnl||0),0);
  const unrEl=document.getElementById('futUnrealised');
  unrEl.textContent='Unrealised: '+(totalUnr>=0?'+$':'-$')+fmt(Math.abs(totalUnr));
  unrEl.className='kpi-change '+(totalUnr>=0?'up':'down');
  document.getElementById('futWinRate').textContent=fmt(fwr,1)+'%';
  document.getElementById('futWinsLosses').textContent=fw+' W / '+fl+' L';
  document.getElementById('futLiqs').textContent=fliq;
  const tpEl=document.getElementById('futTotalPnl');
  tpEl.textContent=(fpnl>=0?'+$':'-$')+fmt(Math.abs(fpnl));
  tpEl.className='kpi-value '+(fpnl>=0?'up':'down');
  const dpEl=document.getElementById('futDailyPnl');
  dpEl.textContent='Today: '+(fdpnl>=0?'+$':'-$')+fmt(Math.abs(fdpnl));
  dpEl.className='kpi-change '+(fdpnl>=0?'up':'down');
  // Positions table
  const prices=d.prices||{};
  document.getElementById('futPositionsTbody').innerHTML=posArr.length?posArr.map(p=>{
    const dirEmoji=p.direction==='long'?'📈':'📉';
    const dirColor=p.direction==='long'?'var(--green)':'var(--red)';
    const unr=p.unrealised_pnl||0;
    const curPrice=prices[p.coin_id]?prices[p.coin_id].price:p.entry_price;
    return `<tr>
      <td><b style="color:var(--yellow)">${p.symbol}</b></td>
      <td style="color:${dirColor}">${dirEmoji} ${p.direction.toUpperCase()}</td>
      <td style="color:var(--yellow);font-weight:700">${p.leverage}x</td>
      <td>$${fmtP(p.entry_price)}</td>
      <td>$${fmtP(curPrice)}</td>
      <td>$${fmt(p.margin)}</td>
      <td>$${fmt(p.notional)}</td>
      <td class="${pnlClass(unr)}">${sign(unr)}$${fmt(Math.abs(unr),4)}</td>
      <td class="up" style="font-size:0.72rem">$${fmtP(p.tp_price)}</td>
      <td class="down" style="font-size:0.72rem">$${fmtP(p.sl_price)}</td>
      <td class="down" style="font-size:0.68rem;color:var(--red)">$${fmtP(p.liq_price)}</td>
    </tr>`;
  }).join(''):'<tr><td colspan="11" class="empty">No open futures positions</td></tr>';
  // History
  const hist=d.futures_history||[];
  document.getElementById('futHistoryTbody').innerHTML=hist.length?hist.slice(0,50).map(p=>{
    const dirEmoji=p.direction==='long'?'📈':'📉';
    const reasonEmoji={take_profit:'🎯',stop_loss:'🛑',liquidation:'💥',signal:'🤖'}[p.exit_reason]||'🔒';
    return `<tr>
      <td><b style="color:var(--yellow)">${p.symbol}</b></td>
      <td>${dirEmoji} ${p.direction}</td>
      <td style="color:var(--yellow)">${p.leverage}x</td>
      <td>$${fmtP(p.entry_price)}</td>
      <td>$${fmtP(p.exit_price)}</td>
      <td>$${fmt(p.margin)}</td>
      <td class="${pnlClass(p.pnl)}">${sign(p.pnl)}$${fmt(Math.abs(p.pnl),4)}</td>
      <td class="${pnlClass(p.roi_pct)}">${sign(p.roi_pct)}${fmt(p.roi_pct,1)}%</td>
      <td>${reasonEmoji} ${(p.exit_reason||'').replace('_',' ')}</td>
      <td style="font-size:0.7rem;color:var(--text-dim)">${(p.exit_time||'').slice(11,16)}</td>
    </tr>`;
  }).join(''):'<tr><td colspan="10" class="empty">No closed futures trades</td></tr>';
}
...
def api_state():
    ...
    # Seed ALL coins — Binance data first for futures-only coins
    for coin_id, symbol in COIN_SYMBOLS.items():
        if coin_id not in prices_data:
            # Use Binance data if available, else seed with zeros
            b_data = binance_data.get(coin_id, {})
            prices_data[coin_id] = {
                "price":      b_data.get("price", 0),
                "symbol":     symbol,
                "name":       symbol,
                "change_1h":  0,
                "change_24h": b_data.get("price_change_pct", 0),
                "change_7d":  0,
                "volume_24h": b_data.get("volume_24h", 0),
                "high_24h":   b_data.get("high_24h", 0),
                "low_24h":    b_data.get("low_24h", 0),
            }

    # Merge Binance real-time prices — these override CoinGecko price field
    for coin_id, b in binance_data.items():
        if coin_id in prices_data:
            if b.get("price", 0) > 0:
                prices_data[coin_id]["price"]      = b["price"]
                prices_data[coin_id]["change_24h"] = b.get("price_change_pct", prices_data[coin_id].get("change_24h", 0))
            ...
            b["symbol"] = COIN_SYMBOLS.get(coin_id, coin_id.upper())
            b["name"]   = COIN_SYMBOLS.get(coin_id, coin_id.upper())
            prices_data[coin_id] = b
    # Futures unrealised PnL updates
    for key, pos in state["futures_positions"].items():
        base = pos["coin_id"].split("_")[0]
        cur  = prices_data.get(base, prices_data.get(pos["coin_id"],{})).get("price",0)
        if cur:
            if pos["direction"] == "long":
                state["futures_positions"][key]["unrealised_pnl"] = round((cur-pos["entry_price"])*pos["qty"],4)
            else:
                state["futures_positions"][key]["unrealised_pnl"] = round((pos["entry_price"]-cur)*pos["qty"],4)

    fut_total = state.get("futures_wins",0) + state.get("futures_losses",0)
    return jsonify({
        **state,
        ...
        "binance_live":         True,
        "futures_win_rate":     round(state.get("futures_wins",0) / fut_total * 100, 1) if fut_total > 0 else 0,
    })
...
def api_control():
    ...
    if action == "pause":
        ...
        target  = data.get("target", "spot")  # "spot" or "futures"
        amount  = max(1, min(amount, 5_000_000))
        if target == "futures":
            state["futures_balance"] += amount
            save_state()
            return jsonify({"message": f"⚡ Futures topped up ${amount:,.2f} — balance: ${state['futures_balance']:,.2f}"})
        else:
            state["cash_balance"] += amount
            save_state()
            return jsonify({"message": f"💰 Spot topped up ${amount:,.2f} — cash: ${state['cash_balance']:,.2f}"})
